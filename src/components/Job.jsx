...
const Job = ({ job }) => {
    ...
    return (
        <div 
            className='p-4 sm:p-5 rounded-md shadow-xl bg-white border border-gray-100 h-[420px] sm:h-[380px] flex flex-col cursor-pointer hover:shadow-2xl transition-shadow duration-200'
